...
parent_row = driver.find_element(By.XPATH, "//table[@id='table']//td[text()='jdoe@hotmail.com']/parent::tr")
print(f"Parent Example -> Email '{email_cell.text}' belongs to row with first name: "
      f"{parent_row.find_element(By.XPATH, './td[]').text}")
